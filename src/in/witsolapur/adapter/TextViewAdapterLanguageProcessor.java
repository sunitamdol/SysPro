...
public class TextViewAdapterLanguageProcessor extends BaseAdapter {
	...
	public TextViewAdapterLanguageProcessor(Context context, int[] nos,String chars[], int rows, int columns) {
